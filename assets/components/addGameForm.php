...
<form method="post" class="form-create">
    ...
    <div class="div-input">
        ...
        <input type="text" name="game_editor" placeholder="Nom de l'éditeur" required/>
    </div>
    <div class="div-input">
        <label for="game_release_date">Date de sortie</label>
        <input type="date" name="game_release_date" placeholder="Date de sortie" required/>
    </div>
    <h2>Plateformes</h2>
    <div class="platforms">
        <?php
    ...
    <div class="div-input">
        ...
        <textarea name="game_description" placeholder="Description du jeu" required></textarea>
    </div>
    <div class="div-input">
        <label for="game_image">URL de la cover</label>
        <input type="text" name="game_image" placeholder="Image du jeu" required/>
    </div>
    <div class="div-input">
        <label for="url_site_game">URL du site</label>
        <input type="text" name="url_site_game" placeholder="URL du site" required/>
    </div>
